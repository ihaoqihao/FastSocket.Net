...
{
    /// <summary>
    /// log listener wrapper
    /// </summary>
    public sealed class LogListenerWrapper : ILogListener
    {
        ...
        public LogListenerWrapper(Action<string> onDebug, Action<string, Exception> onError, Action<string> onInfo)
        {
